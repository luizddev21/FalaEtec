            ...
            <section>
                <form onSubmit={handleSubmit} className="type2">
                    ...
                    {form.title === "professor" && (
                        <div className="camp">
                            <div className="input">
                                <select onChange={handleChange} value={form.professor} name="professor" id="professor" defaultValue="" required>
                                    <option value="" disabled>
                                        Quem é o professor?
                                    </option>
                                    {
                    ...
                    {form.title === "outro" && (
                        <div className="camp">
                            <div className="input">
                                <input onChange={handleChange} value={form.outro} type="text" name="outro" id="outro" required />
                    ...
                    <div className="camp">
                        <div className="input textarea">
                            <textarea onChange={handleChange} value={form.desc} name="desc" id="desc" required></textarea>
